...
Checked items below are done in this repository. Unchecked items still need you: Partner login, linking the app, a development-store install, protected customer data, one real COD order in that store, a live uninstall, and sending the submission yourself. A local synthetic duplicate delivery was already observed.
